...
public final class MetadataUtil
{
 /*   private MetadataUtil() {}
    ...
    public static final JsonCodec<Map<String, List<TwitterTable>>> CATALOG_CODEC;
    public static final JsonCodec<TwitterTable> TABLE_CODEC;
    public static final JsonCodec<TwitterColumnHandle> COLUMN_CODEC;
    ...
    static {
        ...
        CATALOG_CODEC = codecFactory.mapJsonCodec(String.class, listJsonCodec(TwitterTable.class));
        TABLE_CODEC = codecFactory.jsonCodec(TwitterTable.class);
        COLUMN_CODEC = codecFactory.jsonCodec(TwitterColumnHandle.class);
    }
