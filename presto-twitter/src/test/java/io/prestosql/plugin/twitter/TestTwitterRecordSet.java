...
public class TestTwitterRecordSet
{
 /*   private ExampleHttpServer exampleHttpServer;
    ...
    {
        RecordSet recordSet = new TwitterRecordSet(new TwitterSplit(dataUri), ImmutableList.of(
        ...
        recordSet = new TwitterRecordSet(new TwitterSplit(dataUri), ImmutableList.of(
                new TwitterColumnHandle("value", BIGINT, 1),
                new TwitterColumnHandle("text", createUnboundedVarcharType(), 0)));
